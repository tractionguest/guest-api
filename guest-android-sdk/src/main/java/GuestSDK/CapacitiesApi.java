...
import org.openapitools.client.model.CapacityResponse;
import org.openapitools.client.model.CapacitySummary;
...
public class CapacitiesApi {
  ...
  */
  public CapacityResponse getLocationCapacity (String locationId, Integer hoursToCalculate, String timestamp) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    queryParams.addAll(ApiInvoker.parameterToPairs("", "hours_to_calculate", hoursToCalculate));
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (CapacityResponse) ApiInvoker.deserialize(localVarResponse, "", CapacityResponse.class);
      } else {
         return null;
      }
      ...
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((CapacityResponse) ApiInvoker.deserialize(localVarResponse,  "", CapacityResponse.class));
  ...
  */
  public CapacitySummary getLocationCapacitySummary (String locationId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'locationId' is set
    if (locationId == null) {
    ...
    // create path and map variables
    String path = "/locations/{location_id}/capacity_summaries".replaceAll("\\{" + "location_id" + "\\}", apiInvoker.escapeString(locationId.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (CapacitySummary) ApiInvoker.deserialize(localVarResponse, "", CapacitySummary.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param locationId 
  */
  public void getLocationCapacitySummary (String locationId, final Response.Listener<CapacitySummary> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/locations/{location_id}/capacity_summaries".replaceAll("\\{format\\}","json").replaceAll("\\{" + "location_id" + "\\}", apiInvoker.escapeString(locationId.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((CapacitySummary) ApiInvoker.deserialize(localVarResponse,  "", CapacitySummary.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
