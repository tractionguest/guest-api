...
public class InvitesApi {
  ...
  */
  public InviteDetail createRegistrationInvite (String registrationId, String idempotencyKey) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    if (registrationId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'registrationId' when calling createRegistrationInvite",
        new ApiException(400, "Missing the required parameter 'registrationId' when calling createRegistrationInvite"));
    }

    // create path and map variables
    String path = "/registrations/{registration_id}/invites".replaceAll("\\{" + "registration_id" + "\\}", apiInvoker.escapeString(registrationId.toString()));
  ...
  */
  public void createRegistrationInvite (String registrationId, String idempotencyKey, final Response.Listener<InviteDetail> responseListener, final Response.ErrorListener errorListener) {
    ...
    // create path and map variables
    String path = "/registrations/{registration_id}/invites".replaceAll("\\{format\\}","json").replaceAll("\\{" + "registration_id" + "\\}", apiInvoker.escapeString(registrationId.toString()));
