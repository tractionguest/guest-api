...
public class SigninsApi {
  ...
  * Creates a new instance of a &#x60;Signin&#x60;.
   ...
   * @return Signin
  */
  public Signin createSignin (SigninCreateParams signinCreateParams, String idempotencyKey) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = signinCreateParams;
    // verify the required parameter 'signinCreateParams' is set
    if (signinCreateParams == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'signinCreateParams' when calling createSignin",
        new ApiException(400, "Missing the required parameter 'signinCreateParams' when calling createSignin"));
    }
   ...
   * Create a Signin
   * Creates a new instance of a &#x60;Signin&#x60;.
   * @param signinCreateParams A new &#x60;Signin&#x60; to be created.   * @param idempotencyKey An optional idempotency key to allow for repeat API requests. Any API request with this key will only be executed once, no matter how many times it&#39;s submitted. We store idempotency keys for only 24 hours. Any &#x60;Idempotency-Key&#x60; shorter than 10 characters will be ignored
  */
  public void createSignin (SigninCreateParams signinCreateParams, String idempotencyKey, final Response.Listener<Signin> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = signinCreateParams;
  ...
  */
  public SigninDetail getSignin (String signinId, String include) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // create path and map variables
    String path = "/signins/{signinId}".replaceAll("\\{" + "signinId" + "\\}", apiInvoker.escapeString(signinId.toString()));
   ...
   * Get a Signin
   * Gets the details of a single instance of a &#x60;Signin&#x60;.
   * @param signinId A unique identifier for a &#x60;Signin&#x60;.   * @param include A list of comma-separated related models to include
  */
  public void getSignin (String signinId, String include, final Response.Listener<SigninDetail> responseListener, final Response.ErrorListener errorListener) {
    ...
    // create path and map variables
    String path = "/signins/{signinId}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "signinId" + "\\}", apiInvoker.escapeString(signinId.toString()));
  ...
  */
   ...
   * Update a Signin attribute
   * Update, acknowledge, or &#x60;Signout&#x60; a &#x60;Signin&#x60;
   * @param signinId A unique identifier for a &#x60;Signin&#x60;.   * @param signinUpdateParams The only updatable values for a &#x60;Signin&#x60; are &#x60;badge_number&#x60;, &#x60;badge_returned&#x60;, &#x60;is_accounted_for&#x60;, &#x60;is_signed_out&#x60;, and &#x60;is_acknowledged&#x60;. &#x60;is_signed_out&#x60;, and &#x60;is_acknowledged&#x60; are pseudo attributes where once they are set to true, there&#39;s no going back.   * @param idempotencyKey An optional idempotency key to allow for repeat API requests. Any API request with this key will only be executed once, no matter how many times it&#39;s submitted. We store idempotency keys for only 24 hours. Any &#x60;Idempotency-Key&#x60; shorter than 10 characters will be ignored
  */
