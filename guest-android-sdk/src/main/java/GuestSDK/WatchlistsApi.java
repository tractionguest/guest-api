...
public class WatchlistsApi {
  ...
  */
  public void deleteWatchlist (String watchlistId, String idempotencyKey) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // create path and map variables
    String path = "/watchlists/{watchlistId}".replaceAll("\\{" + "watchlistId" + "\\}", apiInvoker.escapeString(watchlistId.toString()));
   ...
   * Deletes a Watchlist
   * Deletes a single instance of &#x60;Watchlist&#x60;
   * @param watchlistId A unique identifier for a &#x60;Watchlist&#x60;.   * @param idempotencyKey An optional idempotency key to allow for repeat API requests. Any API request with this key will only be executed once, no matter how many times it&#39;s submitted. We store idempotency keys for only 24 hours. Any &#x60;Idempotency-Key&#x60; shorter than 10 characters will be ignored
  */
  public void deleteWatchlist (String watchlistId, String idempotencyKey, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    ...
    // create path and map variables
    String path = "/watchlists/{watchlistId}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "watchlistId" + "\\}", apiInvoker.escapeString(watchlistId.toString()));
  ...
  */
   ...
   * Get a Watchlist
   * Gets the details of a single instance of a &#x60;Watchlist&#x60;.
   * @param watchlistId A unique identifier for a &#x60;Watchlist&#x60;.   * @param include A list of comma-separated related models to include
  */
