...
public class JsonUtil {
  ...
  public static Type getListTypeForDeserialization(Class cls) {
    ...
    if ("WatchlistBatchCreateParams".equalsIgnoreCase(className)) {
      return new TypeToken<List<WatchlistBatchCreateParams>>(){}.getType();
    }
  ...
  public static Type getTypeForDeserialization(Class cls) {
    ...
    if ("WatchlistBatchCreateParams".equalsIgnoreCase(className)) {
      return new TypeToken<WatchlistBatchCreateParams>(){}.getType();
    }
