...
public class JsonUtil {
  ...
  public static Type getListTypeForDeserialization(Class cls) {
    ...
    if ("CapacityResponse".equalsIgnoreCase(className)) {
      return new TypeToken<List<CapacityResponse>>(){}.getType();
    }
    
    if ("CapacitySummary".equalsIgnoreCase(className)) {
      return new TypeToken<List<CapacitySummary>>(){}.getType();
    }
  ...
  public static Type getTypeForDeserialization(Class cls) {
    ...
    if ("CapacityResponse".equalsIgnoreCase(className)) {
      return new TypeToken<CapacityResponse>(){}.getType();
    }
    
    if ("CapacitySummary".equalsIgnoreCase(className)) {
      return new TypeToken<CapacitySummary>(){}.getType();
    }
