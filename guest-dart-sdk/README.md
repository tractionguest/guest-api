...
- API version: 0.9.20-hackathon-sininparams
...
```
name: guest_sdk
version: 0.9.20-hackathon-sininparams
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**createGuestNotification**](docs//DefaultApi.md#createguestnotification) | **POST** /guest_notifications | Create a GuestNotification
...
## Documentation For Models
 ...
 - [GuestNotification](docs//GuestNotification.md)
 - [Host](docs//Host.md)
