...
------------ | ------------- | ------------- | -------------
*DeliveriesApi* | [**createDelivery**](docs//DeliveriesApi.md#createdelivery) | **POST** /locations/{locationId}/deliveries | Create Delivery
...
*LocationsApi* | [**createDelivery**](docs//LocationsApi.md#createdelivery) | **POST** /locations/{locationId}/deliveries | Create Delivery
