...
#import "OAIPaginatedAuditLogsList.h"
...
-(NSURLSessionTask*) getAuditLogWithAuditLogId: (NSString*) auditLogId
    ...
    if (auditLogId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIAuditLogsApiErrorDomain code:kOAIAuditLogsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"OAIAuditLog*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIAuditLog*)data, error);
                                }
                            }];
}
...
///
///  @returns OAIPaginatedAuditLogsList*
///
-(NSURLSessionTask*) getAuditLogsWithLimit: (NSNumber*) limit
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIPaginatedAuditLogsList*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIPaginatedAuditLogsList*)data, error);
                                }
                            }];
}
