...
@interface OAIEmailTemplatesApi: NSObject <OAIApi>

extern NSString* kOAIEmailTemplatesApiErrorDomain;
extern NSInteger kOAIEmailTemplatesApiMissingParamErrorCode;
...
///
/// @return OAIPaginatedEmailTemplatesList*
