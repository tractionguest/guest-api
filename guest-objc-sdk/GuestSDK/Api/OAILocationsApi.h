...
@interface OAILocationsApi: NSObject <OAIApi>

extern NSString* kOAILocationsApiErrorDomain;
extern NSInteger kOAILocationsApiMissingParamErrorCode;
...
///
/// @return OAIPaginatedLocationsList*
