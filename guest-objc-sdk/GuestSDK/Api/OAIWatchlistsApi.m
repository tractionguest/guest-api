...
@interface OAIWatchlistsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIWatchlistsApi

NSString* kOAIWatchlistsApiErrorDomain = @"OAIWatchlistsApiErrorDomain";
NSInteger kOAIWatchlistsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) createWatchlistWithWatchlistCreateParams: (OAIWatchlistCreateParams*) watchlistCreateParams
    ...
    if (watchlistCreateParams == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIWatchlistsApiErrorDomain code:kOAIWatchlistsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"OAIWatchlist*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIWatchlist*)data, error);
                                }
                            }];
}
...
///  @param include A list of comma-separated related models to include (optional)
///
///  @returns OAIPaginatedWatchlistList*
///
-(NSURLSessionTask*) getWatchlistsWithLimit: (NSNumber*) limit
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIPaginatedWatchlistList*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIPaginatedWatchlistList*)data, error);
                                }
                            }];
}
