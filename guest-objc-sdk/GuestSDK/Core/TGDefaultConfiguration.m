...
#import "TGBasicAuthTokenProvider.h"
#import "TGLogger.h"

@interface TGDefaultConfiguration ()
...
@implementation TGDefaultConfiguration

#pragma mark - Singleton Methods

+ (instancetype) sharedConfig {
    static TGDefaultConfiguration *shardConfig = nil;
...
- (instancetype) init {
    self = [super init];
    if (self) {
        _host = @"https://mobile-api-refactor-admin.tractionguest.ca/api/v3";
        _username = @"";
        _password = @"";
        _accessToken= @"";
        _verifySSL = YES;
...
- (NSString *) getBasicAuthToken {
    ...
    NSString *basicAuthToken = [TGBasicAuthTokenProvider createBasicAuthTokenWithUsername:self.username password:self.password];
