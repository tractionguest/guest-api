...
NSString *const TGDeserializationErrorDomainKey = @"TGDeserializationErrorDomainKey";

NSInteger const TGTypeMismatchErrorCode = 143553;

NSInteger const TGEmptyValueOccurredErrorCode = 143509;

NSInteger const TGUnknownResponseObjectErrorCode = 143528;


@interface TGResponseDeserializer ()
...
@implementation TGResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:TGDeserializationErrorDomainKey code:TGTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:TGDeserializationErrorDomainKey code:TGEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:TGDeserializationErrorDomainKey code:TGUnknownResponseObjectErrorCode userInfo:userInfo];
}
