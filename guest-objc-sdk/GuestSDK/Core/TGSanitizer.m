...
NSString * const kTGApplicationJSONType = @"application/json";

NSString * TGPercentEscapedStringFromString(NSString *string) {
    static NSString * const kTGCharactersGeneralDelimitersToEncode = @":#[]@";
    static NSString * const kTGCharactersSubDelimitersToEncode = @"!$&'()*+,;=";

    NSMutableCharacterSet * allowedCharacterSet = [[NSCharacterSet URLQueryAllowedCharacterSet] mutableCopy];
    [allowedCharacterSet removeCharactersInString:[kTGCharactersGeneralDelimitersToEncode stringByAppendingString:kTGCharactersSubDelimitersToEncode]];
...
- (id) sanitizeForSerialization:(id) object {
    ...
    else if ([object isKindOfClass:[NSString class]] || [object isKindOfClass:[NSNumber class]] || [object isKindOfClass:[TGQueryParamCollection class]]) {
        return object;
    }
    else if ([object isKindOfClass:[NSDate class]]) {
        return [TGSanitizer dateToString:object];
    }
    ...
    else if ([object isKindOfClass:[TGObject class]]) {
...
- (NSString *) parameterToString:(id)param {
    if ([param isKindOfClass:[NSString class]]) {
        ...
        return [TGSanitizer dateToString:param];
    }
...
+ (NSString *)dateToString:(id)date {
    NSTimeZone* timeZone = [TGDefaultConfiguration sharedConfig].serializationTimeZone;
