...
@protocol TGCapacitySummary
@end

@interface TGCapacitySummary : TGObject


@property(nonatomic) NSNumber* signinsCount;

@property(nonatomic) NSNumber* invitesExpectedNextHour;
