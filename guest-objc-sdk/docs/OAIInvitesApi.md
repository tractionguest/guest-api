...
------------- | ------------- | -------------
[**createLocationInvite**](OAIInvitesApi.md#createlocationinvite) | **POST** /locations/{locationId}/invites | Creates an Invite
[**deleteInvite**](OAIInvitesApi.md#deleteinvite) | **DELETE** /invites/{inviteId} | Deletes an Invite
[**getInvite**](OAIInvitesApi.md#getinvite) | **GET** /invites/{inviteId} | Get a Invite
[**getInvites**](OAIInvitesApi.md#getinvites) | **GET** /invites | List All Invites
[**updateInvite**](OAIInvitesApi.md#updateinvite) | **PUT** /invites/{inviteId} | Update a Invite
...
OAIInviteCreateParams* inviteCreateParams = {"company":"some text","email":"some text","end_date":"2018-02-10T09:30Z","last_name":"some text","start_date":"2018-02-10T09:30Z","title":"some text","watchlist_colour":{},"host_ids":[96,2],"custom_fields":[{"format":{},"field_name":"some text","field_value":"some text"},{"format":{},"field_name":"some text","field_value":"some text"}],"email_template_id":53,"mobile_number":"some text","first_name":"some text","notification_triggers":[{"offset_direction":{},"offset_type":{},"offset_amount":34,"offset_origin":{},"email_template_id":63,"notification_groups":["some text","some text"]},{"offset_direction":{},"offset_type":{},"offset_amount":12,"offset_origin":{},"email_template_id":2,"notification_groups":["some text","some text"]}]}; // 
...
[apiInstance createLocationInviteWithLocationId:locationId
          ...
          completionHandler: ^(OAIInviteDetail* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAIInvitesApi->createLocationInvite: %@", error);
                        }
                    }];
```
 ...
 **inviteCreateParams** | [**OAIInviteCreateParams***](OAIInviteCreateParams.md)|  | 
...
[**OAIInviteDetail***](OAIInviteDetail.md)
...
[apiInstance getInviteWithInviteId:inviteId
          ...
          completionHandler: ^(OAIInviteDetail* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIInvitesApi->getInvite: %@", error);
                        }
                    }];
```
...
[apiInstance getInvitesWithLimit:limit
          ...
          completionHandler: ^(OAIPaginatedInvitesList* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAIInvitesApi->getInvites: %@", error);
                        }
                    }];
```
...
[**OAIPaginatedInvitesList***](OAIPaginatedInvitesList.md)
...
NSString* inviteId = @"inviteId_example"; // A unique identifier for a `Invite`.
OAIInviteUpdateParams* inviteUpdateParams = {"checked_in":true,"on_premise":true,"sent_email":"some text","user_id":45,"device_configuration_id":14}; // Updated `Invite` information.
NSString* idempotencyKey = @"idempotencyKey_example"; // An optional idempotency key to allow for repeat API requests. Any API request with this key will only be executed once, no matter how many times it's submitted. We store idempotency keys for only 24 hours. Any `Idempotency-Key` shorter than 10 characters will be ignored (optional)
...
[apiInstance updateInviteWithInviteId:inviteId
          ...
          completionHandler: ^(OAIInviteDetail* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIInvitesApi->updateInvite: %@", error);
                        }
                    }];
```
...
------------- | ------------- | ------------- | -------------
 **inviteId** | **NSString***| A unique identifier for a &#x60;Invite&#x60;. | 
 **inviteUpdateParams** | [**OAIInviteUpdateParams***](OAIInviteUpdateParams.md)| Updated &#x60;Invite&#x60; information. | 
 **idempotencyKey** | **NSString***| An optional idempotency key to allow for repeat API requests. Any API request with this key will only be executed once, no matter how many times it&#39;s submitted. We store idempotency keys for only 24 hours. Any &#x60;Idempotency-Key&#x60; shorter than 10 characters will be ignored | [optional] 
