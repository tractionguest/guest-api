...
export const APIS = [AuditLogsService, EmailTemplatesService, HostsService, InvitesService, LocationsService, NotificationsService, SigninsService, UsersService, WatchlistsService];
