...
export const APIS = [AuditLogsService, EmailTemplatesService, GuestAlertsService, HostsService, InvitesService, LocationsService, SigninsService, UsersService, WatchlistsService];
