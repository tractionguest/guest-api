...
import { CapacityResponseGuest } from '../model/capacityResponse';
import { CapacitySummaryGuest } from '../model/capacitySummary';
...
export class CapacitiesService {
     ...
     * @param locationId 
     * @param hoursToCalculate The next N number of hours, the data needs to be calculated. Range from 1 to 24. If not set, it defaults to 8.
     ...
     */
    public getLocationCapacity(locationId: string, hoursToCalculate?: number, timestamp?: string, observe?: 'body', reportProgress?: boolean): Observable<CapacityResponseGuest>;
    public getLocationCapacity(locationId: string, hoursToCalculate?: number, timestamp?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<CapacityResponseGuest>>;
    public getLocationCapacity(locationId: string, hoursToCalculate?: number, timestamp?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<CapacityResponseGuest>>;
    public getLocationCapacity(locationId: string, hoursToCalculate?: number, timestamp?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (locationId === null || locationId === undefined) {
            throw new Error('Required parameter locationId was null or undefined when calling getLocationCapacity.');
        }

        let queryParameters = new HttpParams({encoder: new CustomHttpUrlEncodingCodec()});
        if (hoursToCalculate !== undefined && hoursToCalculate !== null) {
            queryParameters = queryParameters.set('hours_to_calculate', <any>hoursToCalculate);
        }
        ...
        return this.httpClient.get<CapacityResponseGuest>(`${this.configuration.basePath}/locations/${encodeURIComponent(String(locationId))}/capacities`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getLocationCapacitySummary(locationId: string, observe?: 'body', reportProgress?: boolean): Observable<CapacitySummaryGuest>;
    public getLocationCapacitySummary(locationId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<CapacitySummaryGuest>>;
    public getLocationCapacitySummary(locationId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<CapacitySummaryGuest>>;
    public getLocationCapacitySummary(locationId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (locationId === null || locationId === undefined) {
            throw new Error('Required parameter locationId was null or undefined when calling getLocationCapacitySummary.');
        }
        ...
        return this.httpClient.get<CapacitySummaryGuest>(`${this.configuration.basePath}/locations/${encodeURIComponent(String(locationId))}/capacity_summaries`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
