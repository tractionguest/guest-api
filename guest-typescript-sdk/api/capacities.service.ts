...
export class CapacitiesService {
     ...
     */
    public getLocationCapacity(locationId: string, hoursToForecast?: number, timestamp?: string, observe?: 'body', reportProgress?: boolean): Observable<CapacityForecastGuest>;
    public getLocationCapacity(locationId: string, hoursToForecast?: number, timestamp?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<CapacityForecastGuest>>;
    public getLocationCapacity(locationId: string, hoursToForecast?: number, timestamp?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<CapacityForecastGuest>>;
    public getLocationCapacity(locationId: string, hoursToForecast?: number, timestamp?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getLocationCapacitySummary(locationId: string, observe?: 'body', reportProgress?: boolean): Observable<CapacityGuest>;
    public getLocationCapacitySummary(locationId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<CapacityGuest>>;
    public getLocationCapacitySummary(locationId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<CapacityGuest>>;
