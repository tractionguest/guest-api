...
export class InvitesService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getInvites(limit?: number, offset?: number, query?: string, withColours?: string, locationIds?: string, sortBy?: 'start_date_asc' | 'start_date_desc' | 'end_date_asc' | 'end_date_desc' | 'created_at_asc' | 'created_at_desc' | 'updated_at_asc' | 'updated_at_desc', startsBefore?: string, startsAfter?: string, include?: string, isApproved?: boolean, observe?: 'body', reportProgress?: boolean): Observable<PaginatedInvitesListGuest>;
    public getInvites(limit?: number, offset?: number, query?: string, withColours?: string, locationIds?: string, sortBy?: 'start_date_asc' | 'start_date_desc' | 'end_date_asc' | 'end_date_desc' | 'created_at_asc' | 'created_at_desc' | 'updated_at_asc' | 'updated_at_desc', startsBefore?: string, startsAfter?: string, include?: string, isApproved?: boolean, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PaginatedInvitesListGuest>>;
    public getInvites(limit?: number, offset?: number, query?: string, withColours?: string, locationIds?: string, sortBy?: 'start_date_asc' | 'start_date_desc' | 'end_date_asc' | 'end_date_desc' | 'created_at_asc' | 'created_at_desc' | 'updated_at_asc' | 'updated_at_desc', startsBefore?: string, startsAfter?: string, include?: string, isApproved?: boolean, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PaginatedInvitesListGuest>>;
    public getInvites(limit?: number, offset?: number, query?: string, withColours?: string, locationIds?: string, sortBy?: 'start_date_asc' | 'start_date_desc' | 'end_date_asc' | 'end_date_desc' | 'created_at_asc' | 'created_at_desc' | 'updated_at_asc' | 'updated_at_desc', startsBefore?: string, startsAfter?: string, include?: string, isApproved?: boolean, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
