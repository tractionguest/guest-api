...
import { WatchlistBatchCreateParamsGuest } from '../model/watchlistBatchCreateParams';
...
export class WatchlistsService {
     ...
     * @param idempotencyKey An optional idempotency key to allow for repeat API requests. Any API request with this key will only be executed once, no matter how many times it\&#39;s submitted. We store idempotency keys for only 24 hours. Any &#x60;Idempotency-Key&#x60; shorter than 10 characters will be ignored
     * @param watchlistBatchCreateParamsGuest 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public createWatchlists(idempotencyKey?: string, watchlistBatchCreateParamsGuest?: WatchlistBatchCreateParamsGuest, observe?: 'body', reportProgress?: boolean): Observable<BatchJobGuest>;
    public createWatchlists(idempotencyKey?: string, watchlistBatchCreateParamsGuest?: WatchlistBatchCreateParamsGuest, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<BatchJobGuest>>;
    public createWatchlists(idempotencyKey?: string, watchlistBatchCreateParamsGuest?: WatchlistBatchCreateParamsGuest, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<BatchJobGuest>>;
    public createWatchlists(idempotencyKey?: string, watchlistBatchCreateParamsGuest?: WatchlistBatchCreateParamsGuest, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<BatchJobGuest>(`${this.configuration.basePath}/watchlists/batch`,
            watchlistBatchCreateParamsGuest,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
